...
#-------------------------------------------------------------------------#
    ...
    #-----------------------------------------------------------------------#
    def FindCoannParticles(self, prompts = True):
    #-----------------------------------------------------------------------#
    #                                                                       #
    ...
    #-----------------------------------------------------------------------#
      ...
      if (len(self._coann_particles) > 0):
        print "-------------------------------"
    ...
    #-----------------------------------------------------------------------#
		...
		#Execute the parameter scan script
		arguments = ' %s'% (self._projectpath)
		curr_dir = os.getcwd()
		
		cmd = os.path.join(curr_dir,self._projectpath+'/'+name_of_script+arguments)
