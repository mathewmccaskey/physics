...
C c (dm_i, dm_j, process_k, group, xinit_min, xinit_max, nsteps, p_or_E, logscale)
C       call cross_check_scan(1,1,1,1,1.d0,1.0d3,201,1,1)
C 
...
C c (dm_i, dm_j, process_k, group, x1init, x2init, p_or_E)
C       write(*,*) cross_check_process(1,1,1,1,1.d3,1.d3,1)
C
...
C c (dm_i, dm_j, process_k, group, x1init, x2init, p_or_E)
C       call matrix_element_check_process(1,1,1,1,1.0d3,1.0d3,0)
