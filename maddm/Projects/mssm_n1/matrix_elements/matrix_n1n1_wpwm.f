      SUBROUTINE SMATRIX_N1N1_WPWM(P,ANS)
C     
...
C     
C     Process: n1 n1 > w+ w- WEIGHTED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 100) THEN
          T=MATRIX_N1N1_WPWM(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION MATRIX_N1N1_WPWM(P,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.12, 2013-08-21
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 1
      CALL VVS1_0(W(1,4),W(1,3),W(1,5),GC_746,AMP(1))
      CALL FFS1_2_3(W(1,2),W(1,1),GC_809,GC_809,MH02,WH02,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL VVS1_0(W(1,4),W(1,3),W(1,5),GC_769,AMP(2))
      CALL FFV4_3(W(1,2),W(1,1),GC_421,MZ,WZ,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL VVV1_0(W(1,4),W(1,3),W(1,5),GC_147,AMP(3))
      CALL FFV2_3_1(W(1,1),W(1,3),GC_427,GC_419,MCH1,WCH1,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL FFV2_3_0(W(1,2),W(1,5),W(1,4),GC_427,GC_419,AMP(4))
      CALL FFV2_3_1(W(1,1),W(1,3),GC_428,GC_652,MCH2,WCH2,W(1,5))
C     Amplitude(s) for diagram number 5
      CALL FFV2_3_0(W(1,2),W(1,5),W(1,4),GC_428,GC_652,AMP(5))
      CALL FFV2_3C1_1(W(1,1),W(1,4),GC_427,GC_419,MCH1,WCH1,W(1,5))
C     Amplitude(s) for diagram number 6
      CALL FFV2_3C1_0(W(1,2),W(1,5),W(1,3),GC_427,GC_419,AMP(6))
      CALL FFV2_3C1_1(W(1,1),W(1,4),GC_428,GC_652,MCH2,WCH2,W(1,5))
C     Amplitude(s) for diagram number 7
      CALL FFV2_3C1_0(W(1,2),W(1,5),W(1,3),GC_428,GC_652,AMP(7))
      JAMP(1)=-AMP(1)-AMP(2)-AMP(3)-AMP(4)-AMP(5)-AMP(6)-AMP(7)

      MATRIX_N1N1_WPWM = 0.D0
      DO I = 1, NCOLOR
        ZTEMP = (0.D0,0.D0)
        DO J = 1, NCOLOR
          ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
        ENDDO
        MATRIX_N1N1_WPWM = MATRIX_N1N1_WPWM+ZTEMP*DCONJG(JAMP(I))
     $   /DENOM(I)
      ENDDO
      END
