      SUBROUTINE SMATRIX_N1N1_VTVTX(P,ANS)
C     
...
C     
C     Process: n1 n1 > vt vt~ WEIGHTED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 100) THEN
          T=MATRIX_N1N1_VTVTX(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION MATRIX_N1N1_VTVTX(P,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.12, 2013-08-21
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFS2_3(W(1,6),W(1,3),GC_412,MSN3,WSN3,W(1,7))
C     Amplitude(s) for diagram number 2
      CALL FFS1_0(W(1,4),W(1,5),W(1,7),GC_412,AMP(2))
      CALL FFS1_3(W(1,4),W(1,1),GC_412,MSN3,WSN3,W(1,7))
C     Amplitude(s) for diagram number 3
      CALL FFS2_0(W(1,2),W(1,3),W(1,7),GC_412,AMP(3))
      JAMP(1)=+AMP(1)+AMP(2)-AMP(3)

      MATRIX_N1N1_VTVTX = 0.D0
      DO I = 1, NCOLOR
        ZTEMP = (0.D0,0.D0)
        DO J = 1, NCOLOR
          ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
        ENDDO
        MATRIX_N1N1_VTVTX = MATRIX_N1N1_VTVTX+ZTEMP*DCONJG(JAMP(I))
     $   /DENOM(I)
      ENDDO
      END
