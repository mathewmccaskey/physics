      SUBROUTINE SMATRIX_N1N1_EMEP(P,ANS)
C     
...
C     
C     Process: n1 n1 > e- e+ WEIGHTED=4
C     Process: n1 n1 > mu- mu+ WEIGHTED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      DO IHEL=1,NCOMB
        IF (GOODHEL(IHEL) .OR. NTRY .LT. 100) THEN
          T=MATRIX_N1N1_EMEP(P ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ...
      REAL*8 FUNCTION MATRIX_N1N1_EMEP(P,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.12, 2013-08-21
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 1
      CALL FFV2_5_0(W(1,4),W(1,3),W(1,5),GC_247,GC_250,AMP(1))
      CALL OXXXXX(P(0,2),MNEU1,NHEL(2),-1*IC(2),W(1,5))
      CALL IXXXXX(P(0,1),MNEU1,NHEL(1),+1*IC(1),W(1,6))
      CALL FFS2_3(W(1,6),W(1,3),GC_538,MSL1,WSL1,W(1,7))
C     Amplitude(s) for diagram number 2
      CALL FFS1_0(W(1,4),W(1,5),W(1,7),GC_538,AMP(2))
      CALL FFS1_3(W(1,6),W(1,3),GC_554,MSL4,WSL4,W(1,7))
C     Amplitude(s) for diagram number 3
      CALL FFS2_0(W(1,4),W(1,5),W(1,7),GC_554,AMP(3))
      CALL FFS1_3(W(1,4),W(1,1),GC_538,MSL1,WSL1,W(1,7))
C     Amplitude(s) for diagram number 4
      CALL FFS2_0(W(1,2),W(1,3),W(1,7),GC_538,AMP(4))
      CALL FFS2_3(W(1,4),W(1,1),GC_554,MSL4,WSL4,W(1,7))
C     Amplitude(s) for diagram number 5
      CALL FFS1_0(W(1,2),W(1,3),W(1,7),GC_554,AMP(5))
      JAMP(1)=+AMP(1)+AMP(2)+AMP(3)-AMP(4)-AMP(5)

      MATRIX_N1N1_EMEP = 0.D0
      DO I = 1, NCOLOR
        ZTEMP = (0.D0,0.D0)
        DO J = 1, NCOLOR
          ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
        ENDDO
        MATRIX_N1N1_EMEP = MATRIX_N1N1_EMEP+ZTEMP*DCONJG(JAMP(I))
     $   /DENOM(I)
      ENDDO
      END
